...
module "lambda" {
  ...
  agent_credential_grant_secret_param_arn  = aws_ssm_parameter.agent_credential_grant_secret.arn
...
module "api" {
  ...
  tools_lambda_invoke_arn                  = module.managed_environments.tool_control_lambda_invoke_arn
  tools_lambda_name                        = module.managed_environments.tool_control_lambda_name
